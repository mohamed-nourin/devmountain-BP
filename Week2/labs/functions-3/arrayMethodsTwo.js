...
let dividedNumbers = numbers.map((number) => {
  return number / 2;
});
...
let citiesEndingWithI = cities.filter((city) => {
...
// CODE HERE
let totalPrice = foods.reduce((total, food) => {
...
console.log("Total price of foods with 'rice' tag:", totalPrice);
